...
<html>
	<head>
		...
		<link href="https://fonts.googleapis.com/css?family=IBM+Plex+Mono:400,400i|IBM+Plex+Sans:300,300i,400,400i,600,700|IBM+Plex+Serif:400,400i,700,700i" rel="stylesheet">
		<link href="https://fonts.googleapis.com/css?family=Lora:400,400i,700|Playfair+Display+SC:400,700,900" rel="stylesheet">
	...
	<body>
		...
		<header id="page_top" class="page_width <?php echo $header_class; ?>">
			<section id="navigation">
				<nav>
					<a href="https://nataleemae.com">Home</a>
					<a href="https://nataleemae.com/about">About</a>
				</nav>
				<nav>
					<a href="https://www.instagram.com/natalee.mae/"><i class="fab fa-instagram"></i></a>
					<a href="mailto:nataleerr@gmail.com"><i class="fas fa-envelope"></i></a>
				</nav>
			</section>
