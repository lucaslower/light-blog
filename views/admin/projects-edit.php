        ...
        <form action="https://<?php echo $app->get_setting('site.url'); ?>/post/edit_project.php" method="POST">
            ...
            <div class="form-group">
                <div class="input-group input-group-lg">
                    ...
                    <input type="text" class="form-control" name="project_title" id="project_title" placeholder="Enter project title" value="<?php echo $project['project_title']; ?>">
                </div>
            </div>

            <!-- PROJECT CONTENT -->
            <div class="form-group">
                <textarea class="form-control" name="project_content" id="project_content" rows="10"><?php echo $project['project_content']; ?></textarea>
            </div>
